...
'Title','DR View',...
'Tag','uibuttongroup1',...
'Position',[handles.DataSel.Position(3)-70, handles.DataSel.Position(4)-(numel(handles.info.DRTypes_)*25+25), 65, numel(handles.info.DRTypes_)*25+10],...
...
'Visible', 'off',...
'Callback',@updateLabel,...
'Tag','customLabelMenus');

% 'Position',[120, yCL, wCL, hCL],...
...
% handles.subSample = uipanel('Parent',handles.DataSel,...
%  'FontUnits','pixels','Units','pixels',...
% 'Title','SubSample',...
% 'Tag','uipanel_select',...
% 'TitlePosition', 'righttop',...
% 'Position',[7 handles.DataSel.Position(4)-35-20 110 30],...
% 'FontSize',8);
% 
% handles.filters.tumorTypeName = uicontrol(...
% 'Parent',handles.subSample,...
% 'FontUnits','pixels',...
% 'Units','pixels',...
...
% 'Style','text',...
% 'Position',...
% [handles.filters.tumorTypeName.Position(1)+handles.filters.tumorTypeName.Position(3)+2,...
% handles.filters.tumorTypeName.Position(2)-20, 65, 13],...
% 'Tag','text4',...
% 'FontSize', 11);
% 
