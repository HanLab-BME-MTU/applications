...
%-------------------------------------------------------------------------------
    ...
    [xCL, yCL, wCL, hCL] = getPosH(handles.cellLabel);
    xposCL = xCL + wCL + 10;
    ...
    function updateAnnotationPanel
        [x, y, w, h] = getPosH(handles.LabelA);
            ...
            if strcmp(handles.cellLabel.String{handles.cellLabel.Value}, 'Annotate') 
                ...
                handles.annoPanel = uipanel(...
                'Parent',handles.LabelA,...
                'FontUnits','pixels',...
                'Units','pixels',...
                'Title','Annotations',...
                'Tag','annoPanel',...
                'Position', [w-120, 30, 100, 50+numA*25], ...
                'FontSize', 12);
...
%     cache_exist = evalc(['exist ''handles.cache.plabel'' ''var'''])
