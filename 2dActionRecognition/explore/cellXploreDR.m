...
'Title','DR View',...
'Tag','uibuttongroup1',...
'Position',[handles.DataSel.Position(3)-70, handles.DataSel.Position(4)-(numel(handles.info.DRTypes_)*25+25), 62, numel(handles.info.DRTypes_)*25+10],...
