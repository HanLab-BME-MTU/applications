...
%                 handles.mainP.Position(4)-handles.LabelA.Position(4)-30],...
    ...
    'Title','Loop Movie',...
    'Tag','ToggleLoop',...
    'Position',[handles.cellInfo.Position(3)+handles.cellInfo.Position(1)+gapSize + 50,...
                handles.LabelA.Position(2) + 200, 100 35],...
    'FontSize', 12,...
    ...
    'Tag','toggleSDC',...
    'Position',[handles.cellInfo.Position(3)+handles.cellInfo.Position(1)+gapSize + 150,...
                handles.LabelA.Position(2) + 200, 150 35],...
    'FontSize', 12,...
    ...
    handles.controlFrameRate = uicontrol(...
                                        ...
                                        'Units','pixels',...
                                        'Tag','pointSize',...
                                        'Position',[handles.cellInfo.Position(3)+handles.cellInfo.Position(1)+gapSize + 365,...
                                                    handles.LabelA.Position(2) + 175, 50 35],...
    ...
    handles.frText = uicontrol('Parent',handles.mainP,...
                       ...
                       'Style','text',...
                       'Position',[handles.cellInfo.Position(3)+handles.cellInfo.Position(1)+gapSize + 330,...
                                   handles.LabelA.Position(2) + 210, 100 20]);
