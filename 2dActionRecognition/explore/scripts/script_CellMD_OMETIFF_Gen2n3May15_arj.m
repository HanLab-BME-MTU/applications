...
if isempty(randset)
    ...
    % Output path
    omeTiffDir = '/work/bioinformatics/shared/dope/data/OMETIFF/rGen2n3_May15';
...
parfor i = 1:length(allCellsSet)
    ...
    metadata.setDatasetDescription([...
        'notes=''for Gen2and3 May14th 2017-ARJ''', 'key=''' iCell.key ''', key_noTime=''' iCell.key_noTime ''',date=''' iCell.date ''',Celltype=''' iCell.cellType ''',metEff=' num2str(iCell.metEff) ',locationStr=' num2str(iCell.locationStr)],0);
