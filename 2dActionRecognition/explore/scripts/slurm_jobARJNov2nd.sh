...
matlab -nodisplay -nodesktop -nosplash -r "run('/home2/s170480/matlab/applications/2dActionRecognition/explore/torch/217x217/script_CellMD_OMETIFF_Nov2017_arj_217x217.m'), exit"