...
dataRootDir = '/work/bioinformatics/shared/dope/torch/test/217x217/';
dataRootDirVal = '/work/bioinformatics/shared/dope/torch/test/217x217/valSet';
dataRootDirTR = '/work/bioinformatics/shared/dope/torch/test/217x217/trainSet';
...
layers = [ ...
    ...
    convolution2dLayer(11, 12, 'Stride', 1, 'Name','conv1')
    batchNormalizationLayer
    reluLayer
    maxPooling2dLayer(3,'Stride',2,'Name','maxPool1')
    convolution2dLayer(5, 25,'Stride',2,'Name','conv2')
    batchNormalizationLayer
    reluLayer
...
options = trainingOptions('sgdm','LearnRateSchedule','piecewise',...
      ...
      'MaxEpochs',1000,'MiniBatchSize',100,...
      'CheckpointPath',fullfile(dataRootDir,'TEMP_val'));    
