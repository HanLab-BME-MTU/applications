...
if ~verLessThan('matlab', '9.3')
    ...
    layers = [ ...netTempDir
        ...
        convolution2dLayer(11, 24, 'Stride', 2,'Name','conv1')
        batchNormalizationLayer
        reluLayer
        maxPooling2dLayer(3,'Stride',2,'Name','maxPool1')
        convolution2dLayer(5, 36,'Stride',2,'Name','conv2')
        batchNormalizationLayer
        reluLayer
        ...
        reluLayer
        convolution2dLayer(3,50,'Name','conv4','Padding','same')
        reluLayer
        convolution2dLayer(3,50,'Name','conv5','Padding','same')
        reluLayer
