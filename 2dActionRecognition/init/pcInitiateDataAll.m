function [] = pcInitiateDataAll(dataDirname,analysisDirname,always)
...
if nargin  == 0
    dataDirname = '/project/bioinformatics/Danuser_lab/liveCellHistology/raw/All/';    
    analysisDirname = '/project/bioinformatics/Danuser_lab/liveCellHistology/analysis/All/';    
    always = true;
end
