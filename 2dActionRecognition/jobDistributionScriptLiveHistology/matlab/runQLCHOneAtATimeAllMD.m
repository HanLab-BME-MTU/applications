...
% Assaf May. 2017
function [] = runQLCHOneAtATimeAllMD(ind)
...
% metaDataFname = [analysisDirname 'MetaData/ExperimentsClones20170810.mat'];
metaDataFname = [analysisDirname 'MetaData/ExperimentsAll20171016a.mat'];
...
mdFname = [analysisDirname 'All/' curFname filesep...
