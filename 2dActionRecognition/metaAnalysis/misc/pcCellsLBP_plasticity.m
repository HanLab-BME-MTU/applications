...
% (e.g., /project/bioinformatics/Danuser_lab/liveCellHistology/analysis/Cells/LBP/FOV/1 (scale)/140604_MV3 (experiment)/s01)
% NOT SUPPORTING BCK,FWD!

% Assaf Zaritsky, June. 2016 (rename Nov. 2016)

function [] = pcCellsLBP_plasticity()
