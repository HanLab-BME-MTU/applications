function [] = pcMorphLocalSpeedMD(MD,params,dirs)
...
save([dirs.results MD.movieDataFileName_(1:end-4) '_localMorphDynam.mat'],'accumulatedSizes','accumulatedEccentricity',...
