    ...
    function obj = BiosensorsPackage (owner,outputDir)
           ...
           if nargin == 0
              super_args = {};
               ...
               tools(1).name = 'Bleedthrough coefficient calculation';
               tools(1).funHandle = @calculateBleedthroughGUI;
               
               tools(2).name = 'Alignement/Registration Transform Creation';
               tools(2).funHandle = @transformCreationGUI;
                            
               super_args{5} = [outputDir  filesep 'BiosensorsPackage']; 
                
           end
           % Call the superclass constructor 
           obj = obj@Package(super_args{:},'tools_',tools);
    end
