...
iclean = 0; %%%%%%%%%%%%%%%%%%%%%% SET CONTROL PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
icut = 5;
itest = 0; %%%%%%%%%%%%%%%%%%%%%%% SET CONTROL PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[oriImageName, oriImagePath] = uigetfile('.tif','Please select the first original image', defaultFileName); %HRJ'.tif'
...
for ix = 1 : 1 : ixmax
    ...
    imwrite(rw,newname,'jpg','Bitdepth',8,'Mode','lossless','Quality',99);
    %
end
