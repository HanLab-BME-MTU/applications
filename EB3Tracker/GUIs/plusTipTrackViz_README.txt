...
the whole image, while 4b and 4c will ask you to select a new ROI.
...
This button calls plusTipPlotTracks.m.

---------------------------------------------------------------------------
4b. Make movie: track overlays
The "Show Tracks" check box and the "Show Detection" radio buttons control
how the tracks and detection are overlaid on the movie. 
The "Save as AVI" check box determines whether the movie will be saved as 
.MOV (default) or .AVI.  In Linux the AVI option tends to crash for some 
reason, so leave unchecked. 
...
interesting tracks to plot (i.e. random bgaps, or backward gaps)

This button calls plusTipTrackMovie.m.
...
This button calls plusTipSpeedMovie.m.
