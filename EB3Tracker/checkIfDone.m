function [result,notDone]=checkIfDone
% checkIfDone returns directory name and projData timestamp for each
% project, as well as which projects have not been analyzed (ie projData
% doesn't exist)
