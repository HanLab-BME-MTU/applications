function [projGroupName,projGroupDir]=combineGroupListFiles(saveResult)
% combineGroupListFiles allows selection of multiple groupList files to combine

% SYNOPSIS: [projGroupName,projGroupDir]=combineGroupListFiles(saveResult)
%
% INPUT   : saveResult: 1 to save new groupList file, 0 to return it to
%                       workspace only
% OUTPUT  : projGroupName,projGroupDir: see plusTipPickGroups.m for details
%
