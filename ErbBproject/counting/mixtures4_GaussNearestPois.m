function [bestk,bestpp,bestmu,bestcov,bestindic,dl,countf] = mixtures4_GaussNearestPois(y,kmin,kmax,lambda,th,globcov,pp,mu,verbose)
%
% Syntax:
...
%
%   2013-02-07
%   Modified to use hard assingments for Pois sum.
%
...
%             end
            ...
            for i=1:k
                if sum(hardIndic(i,:)) > 0
                    temp = singlePoisHard(t,hardIndic(i,:),Pois);
                else
