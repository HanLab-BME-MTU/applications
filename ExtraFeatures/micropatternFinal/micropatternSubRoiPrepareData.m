        ...
        for iIndx = 1:length(projIndx)
            ...
            for iExtract = 1:numel(maskParamsCurrent.extractType)
                ...
                for iSubDir = 1:numel(subRoiDirs)
                    ...
                    plusTipSubRoiExtractTracksFORPACKAGE(subRoiDir,'fraction', 0.01, 'extractType', char(toExtract),'turnFiguresOn',0,'collectPlots',1,'mkPolPlot',1,'turnHistOn',0); % NEED TO fix not ideal input
                end
            end %
