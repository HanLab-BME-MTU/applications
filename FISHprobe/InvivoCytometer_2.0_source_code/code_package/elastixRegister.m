    ...
    if ~isempty(parameters.elastixExe)
       ...
       switch computer('arch')
           ...
           case { 'win32', 'win64'}
                ...
                elastixExeName = 'elastix.exe';
                
           case 'glnxa64' 
               
                elastixExeName = 'elastixLinux';
                
           case 'maci64'     
               
               elastixExeName = 'elastixMac';
        ...
        if ~isdeployed
            ...
            cmdElastix = fullfile(folderExe, elastixExeName);
        else
            cmdElastix = which(elastixExeName); 
        end
