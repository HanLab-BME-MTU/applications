...
if ~isempty(parameters.transformixExe)
    ...
    switch computer('arch')
       ...
       case { 'win32', 'win64'}
            ...
            transformixFileName = 'transformix.exe';

       case 'glnxa64' 

            transformixFileName = 'transformixLinux';

       case 'maci64'     

           transformixFileName = 'transformixMac';
    ...
    if ~isdeployed
        ...
        cmdTransformix = fullfile(folderExe, transformixFileName);
    else
        cmdTransformix = which(transformixFileName);
    end
