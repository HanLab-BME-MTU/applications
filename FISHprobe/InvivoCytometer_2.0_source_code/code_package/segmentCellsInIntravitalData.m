function [ imLabelCellSeg, varargout ] = segmentCellsInIntravitalData( imInput, spacing, varargin )
    ...
    p.addParamValue( 'thresholdingAlgorithm', @(x) (isstruct(x) && isfield(x, {'module', 'parameters'})) );
    ...
    try
        ...
        curThresholdingModuleObj = feval(thresholdingAlgorithm.module);
        curThresholdingModuleObj.setParameters(thresholdingAlgorithm.parameters);  
        imThresh = curThresholdingModuleObj.segmentImage(imAdjusted, spacing);
