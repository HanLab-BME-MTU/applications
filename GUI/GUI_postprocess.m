function varargout = GUI_postprocess(varargin)
...
% Last Modified by GUIDE v2.5 03-Feb-2004 15:51:34
...
[filename,path]=uigetfile({'*.mat','mat-files'},'Please select a file named jobvalues.mat');
...
handles.postpro.moviepath=path;

guidata(hObject, handles);

set(handles.GUI_pp_jobpath_ed,'String',path);
set(handles.GUI_pp_imagepath_ed,'String',handles.jobvalues.imagedirectory);
set(handles.GUI_fm_moviepath_ed,'String',path)
...
% --- Executes during object creation, after setting all properties.
function GUI_fm_moviepath_ed_CreateFcn(hObject, eventdata, handles)
% hObject    handle to GUI_fm_moviepath_ed (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function GUI_fm_moviepath_ed_Callback(hObject, eventdata, handles)
% hObject    handle to GUI_fm_moviepath_ed (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of GUI_fm_moviepath_ed as text
%        str2double(get(hObject,'String')) returns contents of GUI_fm_moviepath_ed as a double
...
% --- Executes on button press in GUI_fm_browsemoviepath_pb.
function GUI_fm_browsemoviepath_pb_Callback(hObject, eventdata, handles)
% hObject    handle to GUI_fm_browsemoviepath_pb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
