...
% Last Modified by GUIDE v2.5 28-Jan-2004 14:48:46
...
defaultjob=struct('imagedirectory',[],'imagename',[],'firstimage',1,'lastimage',[],'increment',1,'savedirectory',[],'fi_background',[],'fi_nucleus',[],'la_background',[],'la_nucleus',[],'maxsearch',48,'mmpixel',[],'minsize',300,'maxsize',1500,'minsdist',30,'halolevel',200,'minedge',10,'sizetemplate',41,'boxsize',141,'noiseparameter',0.15,'mincorrqualtempl',0.2,'leveladjust',0.9,'timestepslide',5,'mintrackcorrqual',0.5,'coordinatespicone',[]) 
...
[filename,path]=uigetfile({'*.tif','TIFF-files';'*.*','all files'},'Please select an image file');

if filename == 0
    return
end

% set(handles.GUI_st_path_imagename_ed,'String',filename(1:end-7));
% set(handles.GUI_st_path_imagedirectory_ed,'String',path);
% Update handles structure
guidata(hObject, handles);
...
handles.jobs(projNum).imagedirectory=path;
...
% --- Executes on button press in GUI_st_path_imagedirectory_browse_pb.
function GUI_st_path_imagedirectory_browse_pb_Callback(hObject, eventdata, handles)
% hObject    handle to GUI_st_path_imagedirectory_browse_pb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles = guidata(hObject);
...
% --- Executes during object creation, after setting all properties.
function GUI_st_bp_halolevel_ed_CreateFcn(hObject, eventdata, handles)
% hObject    handle to GUI_st_bp_halolevel_ed (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function GUI_st_bp_halolevel_ed_Callback(hObject, eventdata, handles)
% hObject    handle to GUI_st_bp_halolevel_ed (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of GUI_st_bp_halolevel_ed as text
%        str2double(get(hObject,'String')) returns contents of GUI_st_bp_halolevel_ed as a double
handles = guidata(hObject);
...
handles.jobs(projNum).halolevel= str2num(numb)
...
% --- Executes on button press in GUI_st_bp_sethalolevel_pb.
function GUI_st_bp_sethalolevel_pb_Callback(hObject, eventdata, handles)
% hObject    handle to GUI_st_bp_sethalolevel_pb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles = guidata(hObject);
...
% --- Executes during object creation, after setting all properties.
function GUI_st_eo_boxsize_ed_CreateFcn(hObject, eventdata, handles)
% hObject    handle to GUI_st_eo_boxsize_ed (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function GUI_st_eo_boxsize_ed_Callback(hObject, eventdata, handles)
% hObject    handle to GUI_st_eo_boxsize_ed (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of GUI_st_eo_boxsize_ed as text
%        str2double(get(hObject,'String')) returns contents of GUI_st_eo_boxsize_ed as a double
handles = guidata(hObject);
...
handles.jobs(projNum).boxsize= str2num(numb)
...
% --- Executes on button press in GUI_st_bp_setall_pb.
function GUI_st_bp_setall_pb_Callback(hObject, eventdata, handles)
% hObject    handle to GUI_st_bp_setall_pb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles = guidata(hObject);
...
handles.jobs(projNum).savedirectory= path
