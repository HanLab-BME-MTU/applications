...
if exist(outgrowthFile)~= 0 ;
    ...
    load([MD.outputDirectory_ filesep 'protrusion_samples_ConstantNumber_windSize_5ReInit61/EdgeVelocityQuantification_CutMovie_1' ...
        filesep 'EdgeMotion.mat']);
    
    analysisResults1 = analysisResults;
    clear analysisResults
    load([MD.outputDirectory_ filesep 'protrusion_samples_ConstantNumber_windSize_5ReInit61/EdgeVelocityQuantification_CutMovie_2' ...
        filesep 'EdgeMotion.mat']);
    ...
    % window.
    [localMeasVeil,predictorsVeil] = GCAAnalysisPartitionVeilParamsByOutgrowth(analysisResults1,analysisResults2,globalMeas);
    ...
    save([multRegDir filesep 'forMultReg'],'forMultReg' ,'measNamesAll'); %
