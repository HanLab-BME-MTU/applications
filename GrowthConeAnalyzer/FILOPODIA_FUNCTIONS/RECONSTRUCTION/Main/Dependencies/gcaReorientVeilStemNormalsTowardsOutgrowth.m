function [normalsCRotated,smoothedEdgeC,normalsC] = gcaReorientVeilStemNormalsTowardsOutgrowth(leadProtrusionPt,LPIndices,normalsC,smoothedEdgeC,dims )
...
if CCs.NumObjects == 1
    ...
    toRemove = intersect(find(borderMask==1),find(backboneMask==1)); 
