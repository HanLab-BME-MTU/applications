function [ filoInfo ] = gcaRecordFilopodiaSeedInformation( CCFiloObjs,img,maxRes,maxTh,edgeMask,bodyMask,analInfoC,normalsC,smoothedEdgeC)
...
% If gcaConnectInternalFilopodia is run previously: it will likewise 
...
%COMMENTED 20141022 will run the fits in a separate step 
