...
framesForAndBack = framesC-5:framesC+5; % need a flag for early/late  guys 
backbones = arrayfun(@(x) analInfo(x).bodyEst.neuriteMask,framesForAndBack,'uniformoutput',0);
            sumBB = zeros(ny,nx);
