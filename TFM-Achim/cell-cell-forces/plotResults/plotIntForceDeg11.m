...
goodEdgeSet=findEdges(groupedClusters,'kPa',8,'deg',1,'myo',0,'type',{'ctr';'ctrl';'myoIIA_hp93';'myoIIA_hp94'},'errs',0);
...
goodEdgeSet=findEdges(groupedClusters,'kPa',35,'deg',1,'myo',0,'type',{'ctr';'ctrl';'myoIIB_hp103'},'errs',0);
[lgth_vals,f1_vals,f2_vals,fc1_vals,fc2_vals]=collectEdgeValues(groupedClusters,goodEdgeSet,'lgth','f1','f2','fc1','fc2');
%deg_vals_sorted=sort(deg_vals,2);
...
goodEdgeSet=findEdges(groupedClusters,'kPa',35,'deg',1,'myo',-1,'type',{'myoIIB_hp103'},'errs',0);
[lgth_vals,f1_vals,f2_vals,fc1_vals,fc2_vals]=collectEdgeValues(groupedClusters,goodEdgeSet,'lgth','f1','f2','fc1','fc2');
%deg_vals_sorted=sort(deg_vals,2);
