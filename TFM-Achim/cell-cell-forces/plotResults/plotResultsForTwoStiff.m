...
[deg_vals_8,lgth_vals_8,fc1_vals_8,nVec_vals_35]=collectEdgeValues(groupedClusters,goodEdgeSet_8,'deg','lgth','fc1','nVec');
...
figure()
% plot both together:
boxplot([intfStress_dbl_sorted_8;intfStress_dbl_sorted_35],{G1 G2},'factorgap',[20 0],'colorgroup',G2,'color','bg','notch','on','symbol','+')
% this should be compared with the following to make sure that the counting is correct:
% h=boxplot(fc_mag_dbl_sorted,num2str(deg_dbl_sorted(:,1)));
title(['Interface force for edges with connectivity: ',num2str(1:maxDeg)])
xlabel('Minimal deg. of connectivity')
