function [localtraction,averaged_localtraction, normbrightness, refbrightness, brightness,contraction] = getlocalforcesovertime(TFM_results, refbrightness)
    [FileName,PathName] = uigetfile('*.tif','Select image file to locate region');
