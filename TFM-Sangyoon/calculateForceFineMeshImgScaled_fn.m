...
fvec = [1200,-100;
        ...
        1100,-380;
        1300,-480;
        850,-280; % large adhesion
        400,-10;

        500,-600;
        450,-700;
        250,-900;
        800,-1200; % large adhesion
        280,-800;
        700,-1000;
...
% For force 1
tnorm1D_org_g1 = fnorm_org(36*imScale,31*imScale-5*imScale:31*imScale+5*imScale);
tnorm1D_FTTCreg_g1 = fnorm_fttcreg(round(36*csScale)+1,round(31*csScale)+1-round(5*csScale):round(31*csScale)+1+round(5*csScale));
tnorm1D_FastBEMreg_g1 = fnorm_FastBEMreg(round(36*csScale)+1,round(31*csScale)+1-round(5*csScale):round(31*csScale)+1+round(5*csScale));
tnorm1D_FastBEMreg2_g1 = fnorm_FastBEMreg2(round(36*csScale)+1,round(31*csScale)+1-round(5*csScale):round(31*csScale)+1+round(5*csScale));
tnorm1D_FTTCregfine_g1 = fnorm_fttcregfine(36*imScale,31*imScale-5*imScale:31*imScale+5*imScale);
tnorm1D_FastBEMregfine_g1 = fnorm_FastBEMregfine(36*imScale,31*imScale-5*imScale:31*imScale+5*imScale);
tnorm1D_FastBEMreg2fine_g1 = fnorm_FastBEMreg2fine(36*imScale,31*imScale-5*imScale:31*imScale+5*imScale);
tnorm1D_FastBEMn1fine_g1 = fnorm_FastBEMn1fine(36*imScale,31*imScale-5*imScale:31*imScale+5*imScale);
x1D_g1 = grid_mat_f(round(36*csScale)+1,round(31*csScale)+1-round(5*csScale):round(31*csScale)+1+round(5*csScale),1);
x1Du_g1 = grid_mat_u(36*imScale,31*imScale-5*imScale:31*imScale+5*imScale,1);
...
tnorm1D_org_g2 = fnorm_org(27*imScale,20*imScale-5*imScale:20*imScale+5*imScale);
tnorm1D_FTTCreg_g2 = fnorm_fttcreg(round(27*csScale)+1,round(20*csScale)+1-round(5*csScale):round(20*csScale)+1+round(5*csScale));
tnorm1D_FastBEMreg_g2 = fnorm_FastBEMreg(round(27*csScale)+1,round(20*csScale)+1-round(5*csScale):round(20*csScale)+1+round(5*csScale));
tnorm1D_FastBEMreg2_g2 = fnorm_FastBEMreg2(round(27*csScale)+1,round(20*csScale)+1-round(5*csScale):round(20*csScale)+1+round(5*csScale));
tnorm1D_FTTCregfine_g2 = fnorm_fttcregfine(27*imScale,20*imScale-5*imScale:20*imScale+5*imScale);
tnorm1D_FastBEMregfine_g2 = fnorm_FastBEMregfine(27*imScale,20*imScale-5*imScale:20*imScale+5*imScale);
tnorm1D_FastBEMreg2fine_g2 = fnorm_FastBEMreg2fine(27*imScale,20*imScale-5*imScale:20*imScale+5*imScale);
tnorm1D_FastBEMn1fine_g2 = fnorm_FastBEMn1fine(27*imScale,20*imScale-5*imScale:20*imScale+5*imScale);
x1D_g2 = grid_mat_f(round(27*csScale)+1,round(20*csScale)+1-round(5*csScale):round(20*csScale)+1+round(5*csScale),1);
x1Du_g2 = grid_mat_u(27*imScale,20*imScale-5*imScale:20*imScale+5*imScale,1);
...
backgroundMask = sqrt((x_mat_f-(locMaxI(1,1)/5+1)).^2+(y_mat_f-(locMaxI(1,2)/5+1)).^2)>r ...
                    ...
                    & sqrt((x_mat_f-(locMaxI(7,1)/5+1)).^2+(y_mat_f-(locMaxI(7,2)/5+1)).^2)>r ...
                    ...
                    & sqrt((x_mat_f-(locMaxI(14,1)/5+1)).^2+(y_mat_f-(locMaxI(14,2)/5+1)).^2)>r ...
