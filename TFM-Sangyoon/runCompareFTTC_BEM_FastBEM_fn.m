...
%% After significant update (multiforce simulation of 500x500)
testForceReconstruction('groupForce',5/100,...
    '/files/.retain-snapshots.d7d-w0d/LCCB/fsm/harvard/analysis/Sangyoon/TFM-Simulation/multiForceIdeal',...
    forceMeshFastBEM,M_FastBEM,...
    '/files/.retain-snapshots.d7d-w0d/LCCB/fsm/harvard/analysis/Sangyoon/TFM Basis Function/basisClassTbl multiFT.mat');
