...
%                 PDE toolbox.
%
% SYNOPSIS : (to be updated for PDE toolbox style.. SH 12/31/2014)
...
%  Originally from Ji, Lin, adopted by Sangyoon Han, Dec 2014.
...
% The cell array style needs to be changed to accommodate PDE toolbox. Or,
% keep this style and use it in assemb and 
...
if isempty(mesh)
   fem.geom = geom;
   fem.mesh = initmesh(fem); %needs to be updated
   fem.mesh = refinemesh(fem); %needs to be updated
