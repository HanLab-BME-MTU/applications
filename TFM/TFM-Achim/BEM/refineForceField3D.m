function [refinedForceField] = refineForceField3D(forceField,frameList,x_out,y_out)
...
for frame=toDoList
    ...
    % This could be x , y , z; pos(:,1), pos(:,2), pos(:,3):
    ...
    [fx, fy, x_out, y_out, M,     ~, ~, sol_coef] = refine_BEM_force_reconstruction(x,y,ux,uy,M_old,refinedForceMesh,E,L,x_out,y_out);
