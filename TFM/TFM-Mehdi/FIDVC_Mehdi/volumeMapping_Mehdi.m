function I = volumeMapping_Mehdi(varargin)
...
u = cell(1,3);
for i = 1:3, u{i} = interp3(u0{i}, m_u0{1}, m_u0{2}, m_u0{3}); end
...
I{1} = interp3(I0{1},  mForward{1}, mForward{2}, mForward{3});
I{2} = interp3(I0{2},  mBackward{1}, mBackward{2}, mBackward{3});
end
