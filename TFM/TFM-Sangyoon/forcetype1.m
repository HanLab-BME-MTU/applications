...
[ux, uy]=fwdSolution(x_mat_u,y_mat_u,E,[],[],[],[],...
    @(x,y) assumedForceAniso2D(1,x,y,10*imScale,10*imScale,1200,-100,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,12*imScale,11*imScale,1800,-160,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,15*imScale,10*imScale,1500,-130,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,11*imScale,14*imScale,1300,-110,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,15*imScale,26*imScale,1100,-380,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,17*imScale,31*imScale,1300,-480,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,28*imScale,27*imScale,850,-280,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,21*imScale,20*imScale,400,-10,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,27*imScale,39*imScale,500,-600,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,31*imScale,42*imScale,450,-700,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,37*imScale,43*imScale,250,-900,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,31*imScale,36*imScale,800,-1200,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,38*imScale,40*imScale,280,-800,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,40*imScale,33*imScale,700,-1000,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,33*imScale,9*imScale,-450,-800,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,39*imScale,18*imScale,-400,550,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,43*imScale,24*imScale,-350,400,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,38*imScale,12*imScale,-350,500,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(1,x,y,42*imScale,17*imScale,-150,600,1*imScale, 2*imScale, forceType),...
    @(x,y) assumedForceAniso2D(2,x,y,10*imScale,10*imScale,1200,-100,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,12*imScale,11*imScale,1800,-160,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,15*imScale,10*imScale,1500,-130,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,11*imScale,14*imScale,1300,-110,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,15*imScale,26*imScale,1100,-380,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,17*imScale,31*imScale,1300,-480,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,28*imScale,27*imScale,850,-280,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,21*imScale,20*imScale,400,-10,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,27*imScale,39*imScale,500,-600,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,31*imScale,42*imScale,450,-700,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,37*imScale,43*imScale,250,-900,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,31*imScale,36*imScale,800,-1200,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,38*imScale,40*imScale,280,-800,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,40*imScale,33*imScale,700,-1000,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,33*imScale,9*imScale,-450,-800,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,39*imScale,18*imScale,-400,550,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,43*imScale,24*imScale,-350,400,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,38*imScale,12*imScale,-350,500,1*imScale, 2*imScale, forceType)+...
    assumedForceAniso2D(2,x,y,42*imScale,17*imScale,-150,600,1*imScale, 2*imScale, forceType),'fft',[],meshPtsFwdSol);
