%[sigma] = getGaussianSmallestPSFsigmaFromData(imageList) returns the s.d. of the Gaussian PSF estimated from the input data.
% The estimation is performed by running pointSourceDetection() with 'sigma' as a free parameter.
% This function is made exclusively for detecting reference beads in TFM package.
% 
% Inputs:
