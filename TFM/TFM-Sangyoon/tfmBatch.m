...
%             uiwait(h); 
        ...
        for jj=1:numOtherChans
            try
                ...
                curXFormAvg.tdata.T = eye(3); %curTavg; % Realized that transformation file is wrong. It's better to just use the raw images
                curXFormAvg.tdata.Tinv = eye(3); %curTinvAvg;
