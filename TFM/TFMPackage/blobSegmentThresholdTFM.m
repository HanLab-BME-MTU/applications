function maskBlobs = blobSegmentThresholdTFM(image,minSize,plotRes,mask)
%BLOBSEGMENTTHRESHOLDTFM segments blobs in 2D images via combination of
%Otsu and Rosin thresholding without performing LoG filtering
%
...
level = 0.66667*level1 + 0.33333*level2;
