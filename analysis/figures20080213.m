...
switch figureId
    ...
    case 2
        ...
        % s1c1dist: idIdx, t, s1c1, s1s2, s1c1:s1s2/s1s2
        ...
        for i=unique(s1c1dist(:,1)'),idx = s1c1dist(:,1) == i;plot(s1c1dist(idx,4),s1c1dist(idx,5),'.','Color',extendedColors(i),'Tag',num2str(i)),end
        xlabel('s1s2 (\mum)'),ylabel('s1c1:s1s2/s1s2 w/ flip')
        figure('Name',sprintf('distance vs spindle length')),hold on
        for i=unique(s1c1dist(:,1)'),idx = s1c1dist(:,1) == i;plot(s1c1dist(idx,4),s1c1dist(idx,3),'.','Color',extendedColors(i),'Tag',num2str(i)),end
        xlabel('s1s2 (\mum)'),ylabel('s1c1 (\mum)')
        figure('Name',sprintf('distance ratio vs spindle length')),hold on
        for i=unique(s1c1dist(:,1)'),idx = s1c1dist(:,1) == i;plot(s1c1dist(idx,4),s1c1dist(idx,3)./s1c1dist(idx,4),'.','Color',extendedColors(i),'Tag',num2str(i)),end
        xlabel('s1s2 (\mum)'),ylabel('s1c1/s1s2')
        figure('Name',sprintf('projected distance vs spindle length')),hold on
        for i=unique(s1c1dist(:,1)'),idx = s1c1dist(:,1) == i;plot(s1c1dist(idx,4),s1c1dist(idx,5).*s1c1dist(idx,4),'.','Color',extendedColors(i),'Tag',num2str(i)),end
        xlabel('s1s2 (\mum)'),ylabel('s1c1:s1s2')
        figure('Name',sprintf('projected distance vs projected distance ratio')),hold on
        for i=unique(s1c1dist(:,1)'),idx = s1c1dist(:,1) == i;plot(s1c1dist(idx,5).*s1c1dist(idx,4),s1c1dist(idx,5),'.','Color',extendedColors(i),'Tag',num2str(i)),end
        xlabel('s1c1:s1s2 (\mum)'),ylabel('s1c1:s1s2/s1s2')
