...
% 
% runArgs = {'BatchMode',true,'ChannelIndex',1,'ForceRun',[0 0 0 0 -1],'1ChannelIndex',1:3,'1Method','SurfaceEnhancement','1PostProcess',true,'1FixJumps',false,'1ThresholdValue',[],'1PreFilterSig',0};
% 
% MAorchestra(n) = process3DMigrationMovie(MAorchestra(n),runArgs{:});
