...
%                  Othewise, this is the percentiles of the distribution generated by the bootstrap algorithm at 
%                  the given alpha 
%
...
if adtest(RetrVeloc)
    ...
    confI(1,2) = meanVeloc(2) + std(RetrVeloc)*1.96/sqrt(length(RetrVeloc));
    confI(2,2) = meanVeloc(2) - std(RetrVeloc)*1.96/sqrt(length(RetrVeloc));
end
