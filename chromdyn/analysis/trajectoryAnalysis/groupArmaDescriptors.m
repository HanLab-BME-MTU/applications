...
def_options.arma_cutoff = 5e-4; %comes from subsampling WT_37, WT_37_ben and kip3d_25
def_options.arma_mode = [0 5e-4];
def_options.wnv2_cutoff = 1e-12; %comes from subsampling WT_37, WT_37_ben and kip3d_25
