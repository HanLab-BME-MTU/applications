...
for iSpot = 1:nSpots
    ...
    set(th.spotPos(iSpot),'String',sprintf(...
        ...
        spotInfo(iSpot).x,full(spotInfo(iSpot).sx),...
        spotInfo(iSpot).y,full(spotInfo(iSpot).sy),...
        spotInfo(iSpot).z,full(spotInfo(iSpot).sz)),...
        'TooltipString',sprintf(...
        ['Positions in mu: X %3.3f',char(177),'%1.3f  Y %3.3f',char(177),...
        '%1.3f  Z %3.3f',char(177),'%2.3f'],...
        spotInfo(iSpot).xmu,full(spotInfo(iSpot).sxmu),...
        spotInfo(iSpot).ymu,full(spotInfo(iSpot).symu),...
        spotInfo(iSpot).zmu,full(spotInfo(iSpot).szmu)),...
        'uicontextmenu',tagPopupMenuH,...
        'UserData',spotInfo(iSpot).tagNumber,'Visible','on');
end
