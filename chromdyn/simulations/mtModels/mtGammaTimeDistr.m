function [simTraj,errFlag] = mtGammaTimeDistr(modelParam,length0,totalTime)
%MTGAMMATIMEDISTR simulates an MT trajectory using the 4 traditional MTDI descriptors
%
...
%23:268-286.
%
%SYNOPSIS [simTraj,errFlag] = mtGammaTimeDistr(modelParam,length0,totalTime)
%
