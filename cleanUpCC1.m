function [CC allFeatures] = cleanUpCC1(nFrames,imSize,pixelSize,distToEdgePath, CC, allFeatures, ...
...
for iFrame = 1:nFrames
    ...
    ind = sub2ind(size(distToEdge), max(1,min(round(y),size(distToEdge,1))),...
        max(1,min(round(x),size(distToEdge,2))));
