function BA_output_cell_GMST = branch_analysis_GMST_movieData(MD,half_size,min_branch_size_Threshold,filament_stat_flag,figure_flag,min_filament_length)
...
%             try
            BA_output = branch_analysis_marked_cell_GMST(MD, iChannel, iCell,...
                half_size,min_branch_size_Threshold,filament_stat_flag,figure_flag,min_filament_length);
%             catch
...
%             end
            ...
            if(~isempty(BA_output))
                BA_output_cell_GMST{iChannel, iCell} = BA_output;            
            end
        end
    end
end

if(~isempty(BA_output_cell_GMST))
      save([ROOT_DIR,filesep,'movieData_BA_output_GMSTminLength.mat'],'BA_output_cell_GMST');
end
