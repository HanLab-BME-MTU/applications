...
set(gca,'fontsize',13);
saveas(h108,[Group_ROOT_DIR,filesep,'Branchness_vs_VimFilamentTotal.fig']);
saveas(h108,[Group_ROOT_DIR,filesep,'Branchness_vs_VimFilamentTotal.tif']);
print(h108,'-depsc',[Group_ROOT_DIR,filesep,'Branchness_vs_VimFilamentTotal.eps']);
...
axis(h108_axis);
set(gca,'fontsize',13);
saveas(h118,[Group_ROOT_DIR,filesep,'Branchness_vs_VimFilamentTotal_Thresholded.fig']);
saveas(h118,[Group_ROOT_DIR,filesep,'Branchness_vs_VimFilamentTotal_Thresholded.tif']);
print(h118,'-depsc',[Group_ROOT_DIR,filesep,'Branchness_vs_VimFilamentTotal_Thresholded.eps']);
...
set(gca,'fontsize',13);
saveas(h128,[Group_ROOT_DIR,filesep,'BranchOrient_vs_VimFilamentTotal.fig']);
saveas(h128,[Group_ROOT_DIR,filesep,'BranchOrient_vs_VimFilamentTotal.tif']);
print(h128,'-depsc',[Group_ROOT_DIR,filesep,'BranchOrient_vs_VimFilamentTotal.eps']);
...
set(gca,'fontsize',13);
saveas(h148,[Group_ROOT_DIR,filesep,'Speed_vs_VimFilamentTotal_color.fig']);
saveas(h148,[Group_ROOT_DIR,filesep,'Speed_vs_VimFilamentTotal_color.tif']);
print(h148,'-depsc',[Group_ROOT_DIR,filesep,'Speed_vs_VimFilamentTotal_color.eps']);
...
set(gca,'fontsize',13);
saveas(h158,[Group_ROOT_DIR,filesep,'Speed_vs_VimFilamentTotal_moreframes.fig']);
saveas(h158,[Group_ROOT_DIR,filesep,'Speed_vs_VimFilamentTotal_moreframes.tif']);
print(h158,'-depsc',[Group_ROOT_DIR,filesep,'Speed_vs_VimFilamentTotal_moreframes.eps']);
