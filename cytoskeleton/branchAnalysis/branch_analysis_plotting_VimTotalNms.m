...
set(gca,'fontsize',13);
saveas(h108,[Group_ROOT_DIR,'\Branchness_vs_VimNmsTotal.fig']);
saveas(h108,[Group_ROOT_DIR,'\Branchness_vs_VimNmsTotal.tif']);
print(h108,'-depsc',[Group_ROOT_DIR,'\Branchness_vs_VimNmsTotal.eps']);
...
axis(h108_axis);
set(gca,'fontsize',13);
saveas(h118,[Group_ROOT_DIR,'\Branchness_vs_VimNmsTotal_Thresholded.fig']);
saveas(h118,[Group_ROOT_DIR,'\Branchness_vs_VimNmsTotal_Thresholded.tif']);
print(h118,'-depsc',[Group_ROOT_DIR,'\Branchness_vs_VimNmsTotal_Thresholded.eps']);
...
set(gca,'fontsize',13);
saveas(h128,[Group_ROOT_DIR,'\BranchOrient_vs_VimNmsTotal.fig']);
saveas(h128,[Group_ROOT_DIR,'\BranchOrient_vs_VimNmsTotal.tif']);
print(h128,'-depsc',[Group_ROOT_DIR,'\BranchOrient_vs_VimNmsTotal.eps']);
...
set(gca,'fontsize',13);
saveas(h148,[Group_ROOT_DIR,'\Speed_vs_VimNmsTotal_color.fig']);
saveas(h148,[Group_ROOT_DIR,'\Speed_vs_VimNmsTotal_color.tif']);
print(h148,'-depsc',[Group_ROOT_DIR,'\Speed_vs_VimNmsTotal_color.eps']);
...
set(gca,'fontsize',13);
saveas(h158,[Group_ROOT_DIR,'\Speed_vs_VimNmsTotal_moreframes.fig']);
saveas(h158,[Group_ROOT_DIR,'\Speed_vs_VimNmsTotal_moreframes.tif']);
print(h158,'-depsc',[Group_ROOT_DIR,'\Speed_vs_VimNmsTotal_moreframes.eps']);
