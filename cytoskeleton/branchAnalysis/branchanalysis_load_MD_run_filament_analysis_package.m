...
default_parameter_cell= branchanalysis_default_parameters(this_MD);
...
%      this_MD = refineMovieMasks(this_MD,default_Params);
    ...
    %%   % 3 image flatten
     ...
     default_Params=default_parameter_cell{3};
    ...
    %% % 4 steerable filter
      ...
      default_Params=default_parameter_cell{4};
    ...
    %%
    % 5 filament segmentation
        default_Params=default_parameter_cell{5};
