...
%  Test try examples:
%
%  filament_network_plotting_with_MD(MD)
%           to get default plotting of two channel white background and red
%           and green lines

%  filament_network_plotting_with_MD(MD,'pixel_based',1,'pixel_dilate_size',2,'image_background_ch',1,'image_inversion',1)
%           to plot pixel based version, with dilation of 2, with background of image channel 1
%
%  filament_network_plotting_with_MD(MD,'marker_type',{'d','.'},'line_widths',[20 10])
%           to plot with default plotting with different marker and size
%
%  filament_network_plotting_with_MD(MD,'pixel_based',1,'pixel_dilate_size',3,'overlay,1,'background_type','image')
%           to plot the original RGB tiff image, and overlay with filaments
%
%  filament_network_plotting_with_MD(MD,'index_channels',[2 1],'network_color_cells',{[1 0 0],[ 0 1 0]},'overlay',1,'background_type','image','image_inversion',1,'image_background_ch',1)
