function filament_network_plotting_with_nMD(nMD_filenames, varargin)
% function to plot network with the convenience of control parameters
% Input:
%   nMD_filenames: the cell of MD filenames to be loaded
% Optional Input:
...
%  Test try examples:
%
%  filament_network_plotting_with_nMD(nMD_filenames)
%           to get default plotting of two channel 1 white background and red
%           and green lines of the first two MD data files

%  filament_network_plotting_with_nMD(nMD_filenames,'pixel_based',1,'pixel_dilate_size',2,'image_background_ch',1,'image_inversion',1)
%           to plot pixel based version, with dilation of 2, with
%           background of image channel 1 of the first two MD data files
%
%  filament_network_plotting_with_nMD(MD,'marker_type',{'d','.'},'line_widths',[20 10])
%           to plot with default plotting with different marker and size
%
%  filament_network_plotting_with_nMD(MD,'pixel_based',1,'pixel_dilate_size',3,'overlay,1,'background_type','image')
%           to plot the original RGB tiff image, and overlay with filaments
%
%  filament_network_plotting_with_nMD(MD,'index_channels',[2 1],'network_color_cells',{[1 0 0],[ 0 1 0]},'overlay',1,'background_type','image','image_inversion',1,'image_background_ch',1)
