...
for iM  = 1 :movieNumber
    ...
    title(['Movie-',num2str(iM),', MT and VIF densities Cross-correlation:', ...
        num2str(corr(MT_density_pool(1:50:end),VIF_density_pool(1:50:end))),'(radius: ',num2str(radius),')']);
    ...
    title(['Movie-',num2str(iM),', MT and scrabled VIF densities Cross-correlation:', ...
        num2str(corr(MT_density_pool(1:50:end),scrable_VIF_density_pool(1:50:end))),'(radius: ',num2str(radius),')']);
    saveas(h12, [ML_ROOT_DIR,filesep,'scrable_VIF_density_correlation_movie',num2str(iM),'(radius',num2str(radius),').tif']);
    saveas(h12, [ML_ROOT_DIR,filesep,'scrable_VIF_density_correlation_movie',num2str(iM),'(radius',num2str(radius),').fig']);
    ...
    title(['Movie-',num2str(iM),', scrabled MT and VIF densities Cross-correlation:', ...
        num2str(corr(scrable_MT_density_pool(1:50:end),VIF_density_pool(1:50:end))),'(radius: ',num2str(radius),')']);
    saveas(h13, [ML_ROOT_DIR,filesep,'scrable_MT_density_correlation_movie',num2str(iM),'(radius',num2str(radius),').tif']);
    saveas(h13, [ML_ROOT_DIR,filesep,'scrable_MT_density_correlation_movie',num2str(iM),'(radius',num2str(radius),').fig']);
    ...
    title(['Movie-',num2str(iM),', scrabled MT and VIF densities Cross-correlation:', ...
        num2str(corr(scrable_MT_density_pool(1:50:end),scrable_VIF_density_pool(1:50:end))),'(radius: ',num2str(radius),')']);
    saveas(h14, [ML_ROOT_DIR,filesep,'scrable_MT_VIF_density_correlation_movie',num2str(iM),'(radius',num2str(radius),').tif']);
    saveas(h14, [ML_ROOT_DIR,filesep,'scrable_MT_VIF_density_correlation_movie',num2str(iM),'(radius',num2str(radius),').fig']);
...
saveas(h21, [ML_ROOT_DIR,filesep,'scrable_VIF_density_correlation_movie',num2str(iM),'(radius',num2str(radius),').fig']);
AA = axis;
...
saveas(h22, [ML_ROOT_DIR,filesep,'scrable_VIF_density_correlation_movie',num2str(iM),'(radius',num2str(radius),').fig']);
...
saveas(h23, [ML_ROOT_DIR,filesep,'scrable_MT_density_correlation_movie',num2str(iM),'(radius',num2str(radius),').fig']);
...
saveas(h24, [ML_ROOT_DIR,filesep,'scrable_MT_VIF_density_correlation_movie',num2str(iM),'(radius',num2str(radius),').fig']);
