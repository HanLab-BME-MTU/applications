...
if(isempty(NA_feature_whole_thisMD{iChannel}))
    ...
    NA_feature_whole_thisMD{iChannel}.nmsmean_ratio_pool_autoDpc    = [ NA_feature_whole_thisMD{iChannel}.nmsmean_ratio_pool_autoDpc;  ...
        NA_feature_thisMD{iChannel, iFrame}.nmsmean_ratio_pool_autoDpc];
