function default_parameter_set = vimscreen_default_parameters(this_MD)
% Set default parameters for vimscreen filament segmentation package, always for all the 5 processes, in order
