...
Group_ROOT_DIR = ML.outputDirectory_;
...
% CCCC(C_IDs)=0;
figure;
plot_color_dot_from_matrix(CCCC1',20,-2, 2)

CCCC2=nan(24,16);
CCCC2(:)=vim_sum_st_pn_Z_bootstrap_mean(:);
% CCCC(C_IDs)=0;
figure;
plot_color_dot_from_matrix(CCCC2',20,-2, 2)

CCCC3=nan(24,16);
CCCC3(:)=vim_length_pn_Z_bootstrap_mean(:);
% CCCC(C_IDs)=0;
figure;plot_color_dot_from_matrix(CCCC3',20,-2, 2)

CCCC4=nan(24,16);
CCCC4(:)=mt_length_pn_Z_bootstrap_mean(:);
% CCCC(C_IDs)=0;
figure;plot_color_dot_from_matrix(CCCC4',20,-2, 2)

figure;plot_color_dot_from_matrix(abs(CCCC1')+abs(CCCC2')+abs(CCCC3')+abs(CCCC4'),20,0, 5);
