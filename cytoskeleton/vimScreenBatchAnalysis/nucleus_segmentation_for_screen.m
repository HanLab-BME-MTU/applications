function [movieData, result_flag_matrix, nucleus_number_matrix] = nucleus_segmentation_for_screen(movieData, paramsIn, varargin)
...
for iChannel =selected_channels
    ...
    for iFrame_index = 1 : length(Frames_to_Seg)
        ...
        if  funParams.background_removal > 0 
          ...
          level_img_OR = (level_img_Otsu+level_im_Rosin)/2;
