...
fnames = exportCode('PointSourceDetection.m','destPath', [dest 'PointSourceDetection' filesep],...
...
masterList = {'cmeAnalysis.m', 'cmeDataViewer.m',...
    ...
    'listSelectGUI.m', 'plotMaxIntVsLifetime.m', 'ccpSorter.m',...
...
exportCode(masterList, 'destPath', dest,...
