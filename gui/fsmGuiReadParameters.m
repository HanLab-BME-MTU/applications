...
gaussRatio=str2double(get(handles.editGauss,'string'));
...
% Number of images
fsmParam.main.imgN=str2double(get(handles.numberEdit,'String'));
...
% Gauss ratio
fsmParam.prep.gaussRatio=str2double(get(handles.editGauss,'String'));

% Sigma
fsmParam.prep.sigma=str2double(get(handles.editSigma,'String'));
...
fsmParam.main.noiseParam(1,1)=str2double(get(handles.editZValue,'String'))/gaussRatio;
fsmParam.main.noiseParam(1,5)=str2double(get(handles.editZValue,'String'));
if ~isempty(indx)
...
fsmParam.main.normMax=2^(str2double(get(handles.bitDepthEdit,'String')))-1;
...
fsmParam.track.threshold=str2double(get(handles.editThreshold,'String'));
fsmParam.track.influence=str2double(get(handles.editInfluence,'String'));
fsmParam.track.initRadius=str2double(get(handles.editInitRadius,'String'));

% Tracker's correlation length
fsmParam.track.corrLength=str2double(get(handles.editCorrLength,'String'));
