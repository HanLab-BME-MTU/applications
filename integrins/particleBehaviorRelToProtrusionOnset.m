function [sptPropInWindow,windowTrackAssign,trackWindowAssign,windowSize,analysisParam] = ...
    particleBehaviorRelToProtrusionOnset(tracksFinal,winPositions,winFrames,...
    protSamples,diffAnalysisRes,minLength,bandRange,windowRange,frameRange)
%particleBehaviorRelToProtrusionOnset averages single particle behavior in windows grouped based on protrusion activity
%
...
if nargin < 4
    disp('--particleBehaviorRelToProtrusionOnset: Missing input arguments!');
    return
end
...
for iBandRange = 1 : numBandRange
    ...
    for iInc = minInc : numWinFrames-2
        ...
        %if the global protrusion event array is not empty
