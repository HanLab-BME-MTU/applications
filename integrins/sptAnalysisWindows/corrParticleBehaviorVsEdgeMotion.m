function [autoCorrProtrusion,crossCorrSptProp] = ...
    corrParticleBehaviorVsEdgeMotion(protPerWindow,sptPropInWindow,...
    prop2analyze,band2analyze,window2analyze,frameRange) %#ok<STOUT,INUSL>
%corrParticleBehaviorVsEdgeMotion looks for correlation between particle behavior and cell edge protrusion activity
%
%SYNOPSIS[autoCorrProtrusion,crossCorrSptProp] = ...
%    corrParticleBehaviorVsEdgeMotion(protPerWindow,sptPropInWindow,...
%    prop2analyze,band2analyze,window2analyze,frameRange)
%
    ...
    for iBand = 1 : numBands
        ...
        switch propName
            case {'spDensity',...
                    ...
                    'f2fDispMagPerpDir','f2fDispSignParaDir',...
