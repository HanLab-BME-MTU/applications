function [cls] = BuildWekaModelForCellCycleStateIdentification( wekaTrainingDataset, outFile, varargin )
    ...
    fidPerformance = fopen( fullfile(pathstr, [fname '_model_performance.txt']), 'w' );    
