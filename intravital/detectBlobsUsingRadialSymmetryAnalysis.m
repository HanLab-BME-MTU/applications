function [ imCellSeedPoints, varargout ] = detectBlobsUsingRadialSymmetryAnalysis( im, blobDiameterRange, varargin )
...
%
    ...
    p.addParamValue( 'numRadiusSamples', 15, @(x) isscalar(x) );
    ...
    radiusValueVec = linspace( 0.5 * blobDiameterRange(1), 0.5 * blobDiameterRange(2), numRadiusSamples);
