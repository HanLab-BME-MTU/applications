function [imCellSeedPoints] = detect_cell_seeds_gvf_edgemap( im, minCellDiameter, varargin )
    ...
    p.addParamValue( 'sigma', 1, @(x) (isnumeric(x) && isscalar(x)) );
    ...
    switch imdims
        ...
        case 2
            ...
            imBlurred = filterGaussND(im, sigma);        
            ...
            % detect cell seed points as strong sources within local extrema of the divergence image
