...
nlms8 = R3.nonLocalMaximaSuppression(maxima);
nms = nlms3(:,:,1);
nlms_mip = nanmax(real(nlms3_m8),[],3);
nlms3_m8_mip = nanmax(real(cat(3,nlms3,nlms3_m8)),[],3);
nlms_all_mip = nanmax(real(cat(3,nlms3,nlms3_m8,nlms8)),[],3);
...
if(~isempty(filename))
    ...
    imwrite(imfuse(nlms_all_mip,I),['nlms_all_vs_I/' filename '_nlms_all_vs_I.png']);
