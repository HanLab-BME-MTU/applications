function [scale] = determineGaussianLineScale(template,start,finish,TOL)
    ...
    if(nargin < 1 || isempty(template))
        ...
        template = repmat(normpdf(-49:50,0,templateScale),100,1);
    end
    ...
    F2 = OrientationSpaceRidgeFilter(1./2/pi./s,[],8,'none');
