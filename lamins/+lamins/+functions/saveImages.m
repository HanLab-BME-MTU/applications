...
%                 S3{ii}.drawEdgesAsLines([],'b');
                ...
                text(50,50,[MD.movieDataFileName_ ' viewed on 2015_06_03'],'Color','y','Interpreter','none');
...
%                 saveas(h, [MD.outputDirectory_ filesep 'skeleton_20150603_' num2str(ii) '.pdf']);
                saveas(h, [MD.outputDirectory_ filesep 'image_20150603_' num2str(ii) '.png']);
                close(h);
            catch err
                if(isvalid(h))
                    close(h);
