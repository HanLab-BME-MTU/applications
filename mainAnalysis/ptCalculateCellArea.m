function [cellProps, clusterProps] = ptCalculateCellArea (imgLabeledCellArea, coord, distanceToCellArea, minSizeNucleus)
% ptCalculateCellArea  determines what areas of an image are occupied by cells and
%                      calculates image properties
%
% SYNOPSIS     [newCoord, cellProps] = ptCalculateCellArea (imgLabeledCellArea, 
%              coord, distanceToCellArea, minSizeNucleus)
%
% INPUT    imgLabeledCellArea : an image where every cluster has a unique label
