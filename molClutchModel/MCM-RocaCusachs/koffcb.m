...
loglog(f, koffcb(f,'mn'));
loglog(f, koffcb(f,'cm'));
loglog(f, koffcb(f,'b3'));
loglog(f, koffcb(f,'b3_lateslip'));
loglog(f, koffcb(f,'b3cm'));
legend('mg','mg_earlyslipmore','mg_earlyslip','mn','cm','b3','b3_lateslip','b3cm')
