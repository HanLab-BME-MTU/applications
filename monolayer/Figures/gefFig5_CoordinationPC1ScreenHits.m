function [] = gefFig5_CoordinationPC1ScreenHits()
...
warning('trancated by 5 becasue of an outlier');
...
set(haxes,'YTick',[-7,0,7]);
set(haxes,'YTickLabel',[-7,0,7]);
...
export_fig([figDname 'coordinationPC1ScreenHits_diff_legend.eps']);
legend off;
...
set(axisHandle,'Position',APosition,'box','off','XMinorTick','off','TickDir','out','YMinorTick','off','FontSize',fontsize,'LineWidth',2);
set(get(axisHandle,'XLabel'),'FontSize',fontsize); set(get(axisHandle,'YLabel'),'FontSize',fontsize);
export_fig([figDname 'coordinationPC1ScreenHits_diff.eps']);
hold off;
