function [] = gefFig5_speedPC1ScreenHits()
...
set(haxes,'YTick',[-2,0,2]);
set(haxes,'YTickLabel',[-2,0,2]);
...
% export_fig([figDname 'speedPC1ScreenHits_diff_legend.eps']);
legend off;
...
set(axisHandle,'Position',APosition,'box','off','XMinorTick','off','TickDir','out','YMinorTick','off','FontSize',fontsize,'LineWidth',2);
set(get(axisHandle,'XLabel'),'FontSize',fontsize); set(get(axisHandle,'YLabel'),'FontSize',fontsize);
export_fig([figDname 'speedPC1ScreenHits_diff.eps']);
hold off;
