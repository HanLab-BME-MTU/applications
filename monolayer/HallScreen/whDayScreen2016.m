...
for ipc = 1 : 7
    ...
    posControlList = {'RAC1','CDC42','beta-PIX'};
    excludeControlList = [];
    %     if ipc == 1 || ipc == 4 || ipc == 7
    %         posControlList = {'RAC1','CDC42','beta-PIX'};
    %         excludeControlList = {'RHOA'};
    %     else if ipc == 3 || ipc == 6
    %             posControlList = {'RHOA'};
    %             excludeControlList = {'RAC1','CDC42','beta-PIX'};
    %         else
    %             continue;
    %         end
    %     end
        ...
        if isfield(dayGeneData{iGeneDay},measuresField)
            ...
            if dayGeneData{iGeneDay}.KD == 0
                ...
                %% Positive control
                    ...
                    if ~ismember(dayGeneData{iGeneDay}.geneStr,excludeControlList)
                        iScreen = iScreen + 1;
    ...
    tmp1 = mean(allThresholds);
    tmp2 = prctile(allThresholds,99);
    tmp3 = prctile(allThresholds,99.9);
    tmp4 = prctile(allThresholds,99.99);
