% Arrange raw data for 201612 (Shefali)
function [] = whMoveRawData201612()

workdir = '/project/bioinformatics/Danuser_lab/GEFscreen/analysis/Data201612_shefali';
transferDir = [workdir filesep 'transferShefali1229/'];
