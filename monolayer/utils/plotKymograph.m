...
nSpacePatches = params.yMaxUm/params.patchSizeUm;%min(floor(params.yMaxUm/params.patchSizeUm),size(kymograph,1));

% new 2016.11.3: limit space of the kymograph
kymograph = kymograph(1:floor(nSpacePatches),:);% bug fixed 20161219
...
yTick = 1:(params.yStepUm/params.patchSizeUm):nSpacePatches; % +1? %yTick = 1:(50/params.patchSize):((180/(params.patchSize))+1);
