...
%       $Revision: 1.9.4.3 $  $Date: 2010/04/11 20:33:29 $
...
while 1,
  ...
  if nonl
    ...
    if gotu
      u=pdenonlin(b,p,e,t,c,a,f,'jacobian',Jac,'U0',u,'tol',Toln,'norm',norm,'MinStep',minStep,'MaxIter',maxIt);
    else
      u=pdenonlin(b,p,e,t,c,a,f,'jacobian',Jac,'tol',Toln,'norm',norm,'MinStep',minStep,'MaxIter',maxIt);
    end
    gotu=1;
  else
