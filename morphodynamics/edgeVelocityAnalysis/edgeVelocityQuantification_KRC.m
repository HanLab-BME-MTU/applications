function [cellData,dataSet] = edgeVelocityQuantification_KRC(movieObj,nIMFs,varargin)
...
cellData   = formatMovieListTimeSeriesProcess_KRC(ML,nIMFs,'ProtrusionSamplingProcess',operations{:});
winFlag    = false;
