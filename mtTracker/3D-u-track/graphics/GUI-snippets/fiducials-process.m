...
% Detecting Poles, creating FoF and projection
buildAndProjectSpindleRef(MDCrop);

processProj=MDCrop.searchPackageName(''buildAndProjectSpindleRef').getProcess(3);
imshow(imread(sprintfPath(processProj.outFilePaths_{2},1)));
