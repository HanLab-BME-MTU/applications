...
for j = 1:numel(i)
    ...
    %submitCommand = ['bsub -R "rusage[mem=10000]" -q danuser_12h "/opt/matlab-2011b/bin/matlab -nosplash -nodesktop -r ''batchSub3DMigration(',num2str(i(j)),')'' "'];
    submitCommand = ['bsub -R "rusage[mem=32000]" -q danuser_7d "/opt/matlab-2011b/bin/matlab -nosplash -nodesktop -r ''batchSub3DMigration(',num2str(i(j)),')'' "'];
