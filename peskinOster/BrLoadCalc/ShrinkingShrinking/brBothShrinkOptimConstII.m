function [c,ceq]=brBothShrinkOptimConstII(x,velData1,velData2,cAngle1,cAngle2,delta,vUnload,pFixe);
...
switch pFixe
    ...
    case 'fixed'
        ...
        c(7)=0.60*v0-velDiscret1(1);
        c(8)=0.60*v0-velDiscret2(1);
        c(9)=v0-1.4*velDiscret1(1);
        c(10)=v0-1.4*velDiscret2(1);
