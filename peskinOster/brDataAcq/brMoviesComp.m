...
[mt1State3,mt2State3,mt1Velocity3,mt2Velocity3,cAngle13,cAngle23,trajMatMt13,trajMatMt23]=brGetAnaData(idlisttrack3 ,dataProperties3 ,lastResult3);
[mt1State5,mt2State5,mt1Velocity5,mt2Velocity5,cAngle15,cAngle25,trajMatMt15,trajMatMt25]=brGetAnaData(idlisttrack5 ,dataProperties5 ,lastResult5);
[mt1State9,mt2State9,mt1Velocity9,mt2Velocity9,cAngle19,cAngle29,trajMatMt19,trajMatMt29]=brGetAnaData(idlisttrack9 ,dataProperties9 ,lastResult9);
[mt1State11,mt2State11,mt1Velocity11,mt2Velocity11,cAngle111,cAngle211,trajMatMt111,trajMatMt211]=brGetAnaData(idlisttrack11 ,dataProperties11 ,lastResult11);
[mt1State18,mt2State18,mt1Velocity18,mt2Velocity18,cAngle118,cAngle218,trajMatMt118,trajMatMt218]=brGetAnaData(idlisttrack18 ,dataProperties18 ,lastResult18);

close all;

oldVelMt1=[mt1Velocity3 ;mt1Velocity5 ;mt1Velocity9 ;mt1Velocity11 ;mt1Velocity18];
oldVelMt2=[mt2Velocity3 ;mt2Velocity5 ;mt2Velocity9 ;mt2Velocity11 ;mt2Velocity18];

oldCAngle1T   =[cAngle13(1:end-1); cAngle15(1:end-1) ;cAngle19(1:end-1) ;cAngle111(1:end-1) ;cAngle118(1:end-1)];
oldCAngle1TdT =[cAngle13(2:end)  ; cAngle15(2:end)   ;cAngle19(2:end)   ;cAngle111(2:end)   ;cAngle118(2:end)  ];

oldCAngle2T   =[cAngle23(1:end-1) ;cAngle25(1:end-1) ;cAngle29(1:end-1) ;cAngle211(1:end-1) ;cAngle218(1:end-1)];
oldCAngle2TdT =[cAngle23(2:end)   ;cAngle25(2:end)   ;cAngle29(2:end)   ;cAngle211(2:end)   ;cAngle218(2:end)  ];



velMt1=[trajMatMt13(:,4);trajMatMt15(:,4);trajMatMt19(:,4);trajMatMt111(:,4);trajMatMt118(:,4)]; 
velMt2=[trajMatMt23(:,4);trajMatMt25(:,4);trajMatMt29(:,4);trajMatMt211(:,4);trajMatMt218(:,4)]; 

cAngle1T=[cAngle13(trajMatMt13(:,1)) ; cAngle15(trajMatMt15(:,1)) ; cAngle19(trajMatMt19(:,1)) ; cAngle111(trajMatMt111(:,1)) ; cAngle118(trajMatMt118(:,1))];
cAngle2T=[cAngle23(trajMatMt23(:,1)) ; cAngle25(trajMatMt25(:,1)) ; cAngle29(trajMatMt29(:,1)) ; cAngle211(trajMatMt211(:,1)) ; cAngle218(trajMatMt218(:,1))];

cAngle1TdT=[cAngle13(trajMatMt13(:,2)) ; cAngle15(trajMatMt15(:,2)) ; cAngle19(trajMatMt19(:,2)) ; cAngle111(trajMatMt111(:,2)) ; cAngle118(trajMatMt118(:,2))];
cAngle2TdT=[cAngle23(trajMatMt23(:,2)) ; cAngle25(trajMatMt25(:,2)) ; cAngle29(trajMatMt29(:,2)) ; cAngle211(trajMatMt211(:,2)) ; cAngle218(trajMatMt218(:,2))];

sigmaMt1=[trajMatMt13(:,5) ; trajMatMt15(:,5) ; trajMatMt19(:,5) ; trajMatMt111(:,5);trajMatMt118(:,5)];
sigmaMt2=[trajMatMt23(:,5) ; trajMatMt25(:,5) ; trajMatMt29(:,5) ; trajMatMt211(:,5);trajMatMt218(:,5)];

stateMt1=[trajMatMt13(:,3) ; trajMatMt15(:,3) ; trajMatMt19(:,3) ; trajMatMt111(:,3);trajMatMt118(:,3)];
stateMt2=[trajMatMt23(:,3) ; trajMatMt25(:,3) ; trajMatMt29(:,3) ; trajMatMt211(:,3);trajMatMt218(:,3)];
