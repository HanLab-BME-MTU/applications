...
% 
% 
% [xResGGTdT,objValT,exitFlag,outPut]=fminimax(@brBothGrowingOptimFct,x0,[],[],[],[],[1e-4 1e-4 1e-4 1e-4  ],[1000 100 1000 100],@brBothGrowingOptimFctConst,opts,velData1,velData2,cAngle1,cAngle2,delta/13);
...
% 
% plot(peskinInv(velData1,xResGGT(1:2),delta/13),velData1,'dr');
% plot(peskinInv(velData2,xResGGT(3:4),delta/13),velData2,'dk');
