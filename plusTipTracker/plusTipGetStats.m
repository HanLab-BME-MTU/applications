...
if gsStats == 1
    ...
    statNames{1,4} = 'growth_speed_mean';
    statNames{1,5} = 'growth_speed_std';
    statNames{1,6} = 'growth_lifetime_median';
    statNames{1,7} = 'growth_lifetime_mean';
    statNames{1,8} = 'growth_lifetime_std';
    statNames{1,9} = 'growth_length_median';
    statNames{1,10} = 'growth_length_mean';
    statNames{1,11} = 'growth_length_std';
    statNames{1,12} = 'percentTimeGrowth';
    statNames{1,13} = 'percentGrowthTerminal';
...
if fgStats == 1 
    ...
    statNamesFG{1,1} = [];   
    statNamesFG{1,2} = 'nFgaps2nGrowths';
    statNamesFG{1,3} = 'fgap_speed_median';
    statNamesFG{1,4} = 'fgap_speed_mean';
    statNamesFG{1,5} = 'fgap_speed_std';
    statNamesFG{1,6} = 'fgap_lifetime_median';
    statNamesFG{1,7} = 'fgap_lifetime_mean';
    statNamesFG{1,8} = 'fgap_lifetime_std';
    statNamesFG{1,9} = 'fgap_length_median';
    statNamesFG{1,10} = 'fgap_length_mean';
    statNamesFG{1,11} = 'fgap_length_std';
    %statNamesFG{1,9} = 'fgap_freq_time';
    %statNamesFG{1,9} = 'fgap_freq_length';
    statNamesFG{1,12} = 'percentTimeFgap';
    statNamesFG{1,13} = 'avgIndivPercentTimeFgap';
    statNamesFG{1,14} = 'percentGrowthLinkedForward';
...
if bgStats ==1 
    ...
    statNames{1,1} = [];   
    statNames{1,2} = 'nBgaps2nGrowths';
    statNames{1,3} = 'bgap_speed_median';
    statNames{1,4} = 'bgap_speed_mean';
    statNames{1,5} = 'bgap_speed_std';
    statNames{1,6} = 'bgap_lifetime_median';
    statNames{1,7} = 'bgap_lifetime_mean';
    statNames{1,8} = 'bgap_lifetime_std';
    statNames{1,9} = 'bgap_length_median';
    statNames{1,10} = 'bgap_length_mean';
    statNames{1,11} = 'bgap_length_std';
    %statNames{1,9} = 'bgap_freq_time';
    %statNames{1,9} = 'bgap_freq_length';
    statNames{1,12} = 'percentTimeBgap'; 
    statNames{1,13} = 'avgIndivPercentTimeBgap';
    statNames{1,14} = 'percentGrowthLinkedBackward';
