function ptManDetectClose(src,eventdata)
% ptManDetectClose is the callback for the clickable cell nuclei
%
% SYNOPSIS       ptManDetectClose
%
% INPUT          none
%
% OUTPUT         none
%
% DEPENDENCIES   ptManDetectClose uses {nothing}
%                                  
%                ptManDetectClose is used by { ptShowImageSequenceDetect, ptShowNextInSequenceDetect }
%
% Revision History
% Name                  Date            Comment
% --------------------- --------        --------------------------------------------------------
...
%     lastProcessedFrame = str2num(get(imageCounterHandle, 'String'));
%     
...
%     if isfield(handlesMain,'firstProcessedFrame')
%         
% %         firstProcessedFrame = handlesMain.firstProcessedFrame;
% % 
