...
%       5 - Transformation (Optional-not run by default)
%       6 - Ratioing
%       7 - Photobleach correction
% 
% Input:
% 
...
%       For example, [ 0 0 -1 1 0 0 0] Means that step 3 should be skipped,
...
%       transformation which is skipped by default.
%
...
if isempty(runSteps)
    ...
    runSteps(strcmp('transformation',procName)) = -1;%Except the transformation, which is skipped by default.
end
