function success = wyssFileTracking(PointList)
...
for i=1:n
    movieInfo = wyssFileConvertforTracking(PointList{i}.fullData);
    ...
    save([PointList{i}.name(1:end-4),'_tracking.mat'],'tracksFinal','features','PointList');    
