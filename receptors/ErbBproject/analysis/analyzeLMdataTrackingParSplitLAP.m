function success=analyzeLMdataTrackingParSplitLAP(dataDirectory,wavelength,varargin)
...
%   saves the results. Uses Parfor for detection and spilts tracking into
%   into pieces which are then remerged via tracksFinalMergerLAP
%
%   Input:
%         required arguments
...
%        Radius  ->  maximum search radius for linking default: 2
%     SplitSize  ->  size of movie fragments used in tracking default: 4000
%  
%   Output:
...
ip.addOptional('SplitSize',4000,@isnumeric);
...
SplitSize = ip.Results.SplitSize;
