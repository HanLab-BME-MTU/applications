function movieData = colocalizationPt2CntWrapper(movieData, paramsIn)
%COLOCALIZATIONPT2CNTWRAPPER applies colocalization method described in colocalMeasurePt2Cnt to a single image or an image set
% 
% movieData = colocalizationPt2CntWrapper(movieData, paramsIn)
%
...
%Get the indices of any previous colocalization processes from this function                                                                              
    iProc = movieData.getProcessIndex('ColocalizationPt2CntProcess',1,0);
