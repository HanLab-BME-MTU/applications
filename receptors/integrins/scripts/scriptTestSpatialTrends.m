condName = {'Beta3'}; %,'AlphaV717Trunc','AlphaV724Trunc','Beta3','Farn','Talin','Lifeact'};
...
%         %particle density
%         testSpatialTrendSignificanceV3paper(sptPropInWindow(iType).directAll.densityParticles,...
...
%             [condName{iCond} ' EdgeWindows_protType' num2str(iType) '.fig']);
        ...
        testSpatialTrendSignificanceV3paper(sptPropInWindow(iType).diffModeAnalysis.diffCoefModeAll,...
