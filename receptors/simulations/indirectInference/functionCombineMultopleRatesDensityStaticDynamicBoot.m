function functionCombineMultopleRatesDensityStaticDynamicBoot(destinationRoot,rDDir,aPDir,dRDir,lRDir,bootRepSize)
    ...
    for dRDirIndx = 1 : length(dRDir)
        ...
        for aPDirIndx = 1 : length(aPDir)
            ...
            for lRDirIndx = 1 : length(lRDir)
                ...
                [rateOnPerClust{iboot},rateOffPerClust{iboot},densityPerClust{iboot},paramVarCovMat{iboot},paramMatrix{iboot}] = ...
