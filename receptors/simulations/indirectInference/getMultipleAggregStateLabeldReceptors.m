function getMultipleAggregStateLabeldReceptors(sourceRoot,saveRoot,rDDir,dRDir,aPDir,outDirNum,lRDir,labelRatio)
...
%                     
                    ...
                    detectionAggregState = genAggregStateFromReceptorLabeledSuperRes(receptorInfoAll,labelRatio(lRDirIndx));
