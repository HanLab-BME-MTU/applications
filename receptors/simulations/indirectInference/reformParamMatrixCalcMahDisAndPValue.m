function [paramMatrixTargetReform,paramMatrixProbeReform]=reformParamMatrixCalcMahDisAndPValue(paramMatrixTarget,paramMatrixProbe)

% This fuction reform the probe and target paramMatrix to have the same size 
% for the calculation of Mahalanobis distance and pValue
%  INPUT:   
...
%   OUTPUT:
%       
%      paramMatrixTargetReform    : target intermediate statistics array
% 
%      paramMatrixProbeReform     : probe intermediate statistics array
%
