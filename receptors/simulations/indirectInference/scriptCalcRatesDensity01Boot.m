...
bootDir='/project/biophysics/jaqaman_lab/interKinetics/ldeoliveira/20170112/bootstrapping';
%Define strings for directory hierarchy as needed
rDDir = {'rD8'};%,'rD8','rD10','rD12','rD14','rD16'};
aPDir = {'aP0p6'};%,'aP0p4','aP0p5','aP0p6','aP0p7','aP0p8'};
outDirNum = 1:10;
