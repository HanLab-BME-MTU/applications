...
% name of the target
rDtarget ={'rD10'};%,'rD20','rD40','rD60','rD80','rD100','rD120','rD140''rD8',
aPtarget = {'aP0p5'};%'aP0p2','aP0p3','aP0p4','aP0p5','aP0p6','aP0p7','aP0p8'
 dRDirT={'dR0p75','dR1','dR1p25'};
 lRtarget={'lR0p2','lR0p4'};
        ...
        for aPTarIndx = 1 : length(aPtarget)
            ...
            for lRTarIndx = 1 : length(lRtarget)
                ...
                currDir=[sourceRootTarget,filesep,rDtarget{rDTarIndx},filesep,...
                    dRDirT{dRTindex},filesep,aPtarget{aPTarIndx},filesep,lRtarget{lRTarIndx}];
                % currDir=[sourceRootTarget,filesep,rDtarget{rDTarIndx},filesep,...
                ...
                for lRDirIndx = 1 : length(lRDir)
                    for dRDirIndx = 1 : length(dRDir)
                        ...
                        for aPDirIndx = 1 : length(aPDir)
                            ...
                            for rDDirIndx = 1 : length(rDDir)
                                ...
                                [sMatrix(dRDirIndx,aPDirIndx,rDDirIndx,lRDirIndx),pMatrix(dRDirIndx,aPDirIndx,rDDirIndx,lRDirIndx)]=calculationMahalonobisDistanceandPvalue(paramMatrixTarget,paramMatrixProbe);
                    ...
                    %save s and p matrix
                    %make a directory
                    resultsDirBoot=[resultsDirectory,filesep,rDtarget{rDTarIndx},dRDirT{dRTindex},aPtarget{aPTarIndx},lRtarget{lRTarIndx}];
