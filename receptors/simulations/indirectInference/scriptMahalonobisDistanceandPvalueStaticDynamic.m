...
targetRoot{1}='/project/biophysics/jaqaman_lab/interKinetics/ldeoliveira/20170517/superRes/varyLabelFraction/analysis/targetIS_sT25_dT0p1';
...
sourceRootProbe=cell(1,5);
% probe source root
sourceRootProbe{1} ='/project/biophysics/jaqaman_lab/interKinetics/ldeoliveira/20170316/superResol/staticData/analysis/probeIS_sT25_dT0p1';
sourceRootProbe{2} ='/project/biophysics/jaqaman_lab/interKinetics/ldeoliveira/20170316/superResol/staticData/analysis/probeIS_sT25_dT0p1';
sourceRootProbe{3} ='/project/biophysics/jaqaman_lab/interKinetics/ldeoliveira/20170313/staticData/probe/analysis';
...
saveDirectory='/project/biophysics/jaqaman_lab/interKinetics/ldeoliveira/20170323/superResol/staticData/results/onlySuperRes/targetIS_sT25_dT0p1';
%
% % name of the target
...
lRtarget = {'lR0p99'};%,'lR0p09','lR0p12','lR0p18'
...
rDDir = {'rD2','rD4','rD6','rD8','rD10','rD12','rD14','rD16'};%,{'rD20','rD40','rD60','rD80','rD100','rD120','rD140'}
        ...
        for rDDirIndx = 1 : length(rDDir)
            ...
            for aPDirIndx = 1 : length(aPDir)
                ...
                for lRIndex=1:size(lRProbe,1)
                    ...
                    [sMatrix(rDDirIndx,aPDirIndx,lRIndex),pMatrix(rDDirIndx,aPDirIndx,lRIndex)]=calculationMahalonobisDistanceandPvalueDynamicStatic(thetaTargetFinal,thetaProbeFinal,vTargetFinal,vProbeFinal);
                    ...
                    resultsDir=[saveDirectory,filesep,rDtarget{1},aPtarget{1},lRtarget{1}];
%                      mkdir(resultsDir)
