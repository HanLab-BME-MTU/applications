...
resultsDirectory='/project/biophysics/jaqaman_lab/interKinetics/ldeoliveira/20170428';
currFile='/project/biophysics/jaqaman_lab/interKinetics/ldeoliveira/20170428';

%load the information about the simulations

load([currFile,filesep,'infoAllSimTarget.mat']);
load([currFile,filesep,'infoAllSimProbe.mat']);

%target 

sourceRootTarget =infoAllSimTarget{1,1};
% Load info for target

rDtarget = infoAllSimTarget{1,2}{1,1};%,'rD60','rD80','rD120','rD140','rD160'};
aPtarget = infoAllSimTarget{1,2}{1,2};%'aP0p2','aP0p3','aP0p4','aP0p5','aP0p6','aP0p7','aP0p8'
dRDirT=infoAllSimTarget{1,2}{1,3};
lRtarget = infoAllSimTarget{1,2}{1,4};

%Load info for probe

sourceRootProbe =infoAllSimProbe{1,1};
%Define strings for directory hierarchy as needed
rDDir =infoAllSimProbe{1,2};
aPDir =infoAllSimProbe{1,3};
dRDir =infoAllSimProbe{1,4};
lRDir =infoAllSimProbe{1,5};
...
% load ratesAndDensity that has the paramMatrix 
 currDir=[sourceRootTarget,filesep,rDtarget,filesep,...
                 dRDirT,filesep,aPtarget,filesep,lRtarget];
...
%save s and p matrix
%make a directory
resultsDirBoot=[resultsDirectory,filesep,dRDir{dRDirIndx},'Target',filesep,dRDir{dRDirIndx},filesep,rDtarget,aPtarget,lRtarget];
