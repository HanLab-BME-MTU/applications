...
resultsDirectory='/project/biophysics/jaqaman_lab/interKinetics/ldeoliveira/20170316/superResol/staticData/results';


sourceRootTarget='/project/biophysics/jaqaman_lab/interKinetics/ldeoliveira/2016/12/20161201/analysis/targetIS_sT10_dT0p1';

%Define strings for directory hierarchy as needed
 rDtarget = {'rD20'};%,'rD60','rD80','rD120','rD140','rD160'};
...
%Define strings for directory hierarchy as needed
rDDir = {'rD20','rD40','rD60','rD80','rD100','rD120','rD140','rD160'};%,{'rD20','rD40','rD60','rD80','rD100','rD120','rD140'}
aPDir = {'aP0p2','aP0p3','aP0p4','aP0p5','aP0p6','aP0p7','aP0p8'};
lRDir = {'lR0p01','lR0p02','lR0p03','lR0p04','lR0p05','lR0p06'};%,'aP0p4','aP0p5','aP0p6','aP0p7','aP0p8'};
...
[sMatrix(rDDirIndx,aPDirIndx,lRDirIndx),pMatrix(rDDirIndx,aPDirIndx,lRDirIndx)]=calculationMahalonobisDistanceandPvalueTry(paramMatrixTarget,paramMatrixProbe);      
