...
for iM = 1 : numMovies
    ...
    progressTextMultiple('channel', length(MD.channels_));
    ...
    for iC = curChannels
        ...
        % TODO: load into a structure so we know what comes out of this
        load(MD.processes_{iProcDiff}.outFilePaths_{iC});
        ...
        resSummary(iM,iC).confRadMeanPerClass = confRadMeanPerClass;
        resSummary(iM,iC).ampMeanPerClass = ampMeanPerClass;
