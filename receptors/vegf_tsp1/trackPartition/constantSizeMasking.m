function mask = constantSizeMasking(movieInfo,MD,threshold)
%CONSTANTSIZEMASKING Creates an image mask based on detection results
%   mask = constantSizeMasking(movieInfo,MD,maskSize)
