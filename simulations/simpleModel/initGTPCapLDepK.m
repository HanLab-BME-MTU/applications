...
modelParam = struct('minLength',0.2,'maxLength',1.5,'kTOnTFree',1.2,'addAmpT',1,'addWidT',10,'addLenT',0.85,'kTOff',0.0,'kTOnD',0.4,'kDOffFree',40,'addAmpD',20,'addWidD',10,'addLenD',0.85,'kHydrolysis',25);
