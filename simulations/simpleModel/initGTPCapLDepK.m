...
modelParam = struct('minLength',0.4,'maxLength',0.8,'kTOnTFree',0.75,'addAmpT',0.72,...
    'addWidT',20,'addLenT',0.6,'kTOff',0.0,'kTOnD',0.4,'kDOffFree',105,'addAmpD',90,...
    'addWidD',20,'addLenD',0.6,'kHydrolysis',14);
