function [params, ImBG] = subResSegment2DInit(I,sigmaPSF,minSize)
% This function provides initial detection of sub-resolution 2D segment.
% This initilization can be then use in an optimization scheme using
% lsqnonlin or lsqlin functions (see subResSegment2DFit for more details).
%
% [params, ImBG] = subResSegment2DInit(I,sigmaPSF,minSize)
%
% INPUT
% I            the image
%
...
%
% minSize      size under which any connected component detected during the
%              pre-segmentation is discarded.
%
