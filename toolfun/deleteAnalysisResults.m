%deleteAnalysisResults(data, dirList) removes directories generated by cmeAnalysis
%
% To delete the 'Detection' and 'Tracking' folders, run
%   deleteAnalysisResults(data, {'Detection', 'Tracking'})
