...
avgDispValues = [avgDispStart avgDispEnd avgDispCutover];
...
percSingleValues = [percSingleStart percSingleEnd percSingleCutover];
...
% Plot all the cells in all the frames against their velocities
